    ...
    <form id="form1" runat="server">
        <div class="auto-style1">
            <asp:Panel ID="Panel1" runat="server">
                ...
                <asp:Label ID="Label2" runat="server" Text="Pet Groomers in Delhi🐾" Font-Bold="True" Font-Italic="False" Font-Names="Harrington" Font-Overline="False" Font-Size="XX-Large" ForeColor="#F7630C" Visible="false"></asp:Label>
            </asp:Panel>
            ...
            <asp:Panel ID="Panel2" runat="server" Height="404px" CssClass="auto-style3">
                <div id="productContainer" runat="server" class="product-container">
                    ...
                    <asp:ImageButton ID="ImageButton2" runat="server" ImageUrl="~/maps/banglore.jpg" CssClass="image-button" />
